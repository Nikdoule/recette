 ...
 */
final class Version20190928104630 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE unites (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__ingredients AS SELECT id, nom, quantite FROM ingredients');
        ...
        $this->addSql('INSERT INTO ingredients (id, nom, quantite) SELECT id, nom, quantite FROM __temp__ingredients');
